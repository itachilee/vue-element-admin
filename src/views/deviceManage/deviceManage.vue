<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="设备地址" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.deviceAddress }}</span>
        </template>
      </el-table-column>
      <el-table-column label="取水" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.waterIntake }}</span>
        </template>
      </el-table-column>
      <el-table-column label="倾斜" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.tilt }}</span>
        </template>
      </el-table-column>
      <el-table-column label="异压" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.pressError }}</span>
        </template>
      </el-table-column>
      <el-table-column label="拆盖" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.uncover }}</span>
        </template>
      </el-table-column>
      <el-table-column label="偷窃" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.steal }}</span>
        </template>
      </el-table-column>
      <el-table-column label="失联" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.offline }}</span>
        </template>
      </el-table-column>
      <el-table-column label="低电" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.voltage }}</span>
        </template>
      </el-table-column>
      <el-table-column label="维护" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.maintanence }}</span>
        </template>
      </el-table-column>
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/deviceManage'
